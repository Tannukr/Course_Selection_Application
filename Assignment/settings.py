...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-^#f37v^%9_!pc1s9bd(@sfh5ty68eu@y!e=cb!2j01v_hbrt*u')
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DATABASE_NAME", "Task1db"),
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'Task1', 'static'),
]
